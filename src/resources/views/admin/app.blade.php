          ...
          <div class="wrapper">
            ...
            <div class="sidebar-wrapper" data-simplebar="true">
              ...
              <ul class="metismenu" id="menu">
                <li class="{{Request::is('analytics/admin') ? 'mm-active' : ''}}">
                  <a href="{{ route('admin') }}">
                    <div class="parent-icon icon-color-9"><i class="fa fa-home"></i></div>
                    <div class="menu-title">Stats</div>
                  </a>
                </li>
                <li class="{{Request::is('analytics/clicks') ? 'mm-active' : ''}}">
                  <a href="{{ route('clicks') }}">
                    <div class="parent-icon icon-color-9"><i class="fa fa-arrow-up"></i></div>
                    <div class="menu-title">Clicks</div>
                  </a>
                </li>
                <li class="{{Request::is('analytics/payments-request') ? 'mm-active' : ''}}">
                  <a href="{{ route('payments-requests') }}">
                    <div class="parent-icon icon-color-9"><i class="fa fa-money"></i></div>
                    <div class="menu-title">Payments</div>
                  </a>
                </li>
                <li class="{{Request::is('analytics/users-list') ? 'mm-active' : ''}}">
                  <a href="{{ route('users-list') }}">
                    <div class="parent-icon icon-color-9"><i class="fa fa-users"></i></div>
                    <div class="menu-title">Users</div>
                  </a>
                </li>
                <li class="{{Request::is('analytics/domains-list') ? 'mm-active' : ''}}">
                  <a href="{{ route('domains-list') }}">
                    <div class="parent-icon icon-color-9"><i class="fa fa-desktop"></i></div>
                    <div class="menu-title">Websites</div>
                  </a>
                </li>
                <li class="{{Request::is('analytics/admin/ad-code') ? 'mm-active' : ''}}">
                  <a href="{{ route('ad-codes') }}">
                    <div class="parent-icon icon-color-9"><i class="fa fa-database"></i></div>
                    <div class="menu-title">Ad Codes</div>
                  </a>
                </li>
              </ul>
              <!--end navigation-->
                  ...
                  <ul class="navbar-nav">
                    <li class="nav-item dropdown dropdown-user-profile">
                      ...
                      <div class="dropdown-menu dropdown-menu-right">	
                        <a class="dropdown-item" href="{{ route('settings-admin') }}">
